...
use Rack::Session::EncryptedCookie,
  :secret => 'sk_test_51HtoM6HiHCEmGiHuRjiBmv3D06ujxH4n0otnDzbBWVfL0ODSHRDLx2ekS32ywLNb5NqxZUCtTfT8hPN45jedWndV00R1aEscE7' # Actually use something secret here!
  ...
  if session.has_key?(:customer_id)
    ...
    if default_customer_id
      ...
      begin
        ...
        if (Stripe.api_key.start_with?('sk_test_51HtoM6HiHCEmGiHuRjiBmv3D06ujxH4n0otnDzbBWVfL0ODSHRDLx2ekS32ywLNb5NqxZUCtTfT8hPN45jedWndV00R1aEscE7'))
